...
// at commit 0b7a6fa, not estimated.
// ---------------------------------------------------------------------------
...
const remaining = [
  ['PayFast sandbox and go-live', 'The adapter is written and tested. What is left needs a merchant account: confirming PayFast accepts our signature, then failure and retry testing against their sandbox', 2, 'PayFast per-transaction fee'],
  ...
  ['Uber Direct onboarding', 'The adapter is written and tested. What is left needs an Uber Direct account: confirming they accept our dispatch, and a postal code at checkout so an address is complete', 3, 'Uber commission per delivery'],
      ...
      children: [
        ...
        table(
          ...
          [
            ...
            ['Automated tests', '606', 'In 31 files; all passing'],
        ...
        table(
          ...
          [
            ...
            ['Tests', '606 passing', '31 files, including four real worker processes racing on one file'],
