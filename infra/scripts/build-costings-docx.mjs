...
/**
 * Every figure comes from here, and so does the HTML rendering beside it. Two
 * documents that must agree are two documents that need one source; this file
 * decides only how the numbers look on a page.
 */
import {
  BRANCH,
  BUILT_DAYS,
