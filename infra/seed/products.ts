...
export const PRODUCTS: readonly Product[] = [
  ...
  {
    id: 'P-little-crunch-chicken-meal',
    ...
    sauce: 'No sauce',
    description:
      'A kid-friendly serving of crispy, golden fried chicken pieces served as a complete meal with a small side and a drink.',
    imageKey: 'little-crunch-chicken-meal',
    nutrition: { allergens: 'Wheat, soya', kilojoules: 1_640 },
    soldOut: false,
  },
  {
    id: 'P-little-chicken-strips-meal',
    ...
    sauce: 'Dipping sauce',
    description:
      'Tender, crispy boneless chicken strips served as a complete kids meal with a small side and a drink.',
    imageKey: 'little-chicken-strips-meal',
    nutrition: { allergens: 'Wheat, soya, egg', kilojoules: 1_720 },
    soldOut: false,
  },
  {
    id: 'P-little-cheesling-burger-meal',
    ...
    sauce: 'Cheese sauce',
    description:
      'A smaller kid-friendly Cheesling Burger served as a complete meal with a side and a drink.',
    imageKey: 'little-cheesling-burger-meal',
    nutrition: { allergens: 'Wheat, soya, egg, milk', kilojoules: 1_980 },
    soldOut: false,
  },
  {
    id: 'P-little-k-rice-chicken-meal',
    slug: 'little-k-rice-chicken-meal',
    name: 'Little K-Rice Chicken Meal',
    category: 'Kids',
    priceCents: 8_500,
    heat: 1,
    sauce: 'Sweet and mild',
    description:
      'A kid-friendly Korean-style chicken and rice meal with a smaller portion designed for children, presented as a complete meal.',
    imageKey: 'little-k-rice-chicken-meal',
    nutrition: { allergens: 'Wheat, soya, sesame', kilojoules: 1_890 },
    soldOut: false,
  },
];