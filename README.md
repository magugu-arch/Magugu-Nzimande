...
| `npm run audit:screens` | Render all 54 routes at two widths; fail on overflow, blank screens, console errors or §32.6 gaps |
...
`npm run audit:screens` on all 54 routes, rather than asserted here.
