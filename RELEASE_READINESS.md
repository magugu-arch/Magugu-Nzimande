...
| Menu search and browsing work | Pass | `audit:screens` sweeps 58 routes; search covered in `menu.test.ts` |
...
- `npm run verify` — **85 suites**, typecheck and lint clean (`npm test` prints the case count)
- `npm run audit:screens` — 58 routes at 390pt and 320pt, no defects
