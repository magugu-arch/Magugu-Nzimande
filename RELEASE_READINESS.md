...
| Menu search and browsing work | Pass | `audit:screens` sweeps 69 routes; search covered in `menu.test.ts` |
...
- `npm run verify` — **89 suites**, typecheck and lint clean (`npm test` prints the case count)
