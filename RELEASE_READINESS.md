...
| Menu search and browsing work | Pass | `audit:screens` sweeps 45 routes; search covered in `menu.test.ts` |
...
- `npm run verify` — **80 suites**, typecheck and lint clean (`npm test` prints the case count)
- `npm run audit:screens` — 45 routes at 390pt and 320pt, no defects
