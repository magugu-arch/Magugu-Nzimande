...
| Menu search and browsing work | Pass | `audit:screens` sweeps 42 routes; search covered in `menu.test.ts` |
...
- `npm run verify` — **78 suites**, typecheck and lint clean (`npm test` prints the case count)
- `npm run audit:screens` — 42 routes at 390pt and 320pt, no defects
