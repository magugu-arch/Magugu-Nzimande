...
| Menu search and browsing work | Pass | `audit:screens` sweeps 50 routes; search covered in `menu.test.ts` |
...
- `npm run verify` — **82 suites**, typecheck and lint clean (`npm test` prints the case count)
- `npm run audit:screens` — 50 routes at 390pt and 320pt, no defects
